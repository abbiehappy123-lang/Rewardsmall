...
| 文件 | 字族名 | 用途 |
|------|--------|------|
| `assets/fonts/MFYuanHei-Boldtalic.ttf` | MFYuanHei | 页面大标题 / 活动权益标题 / 底部金额数字 |

### 切图（assets/images/）
| 文件名 | 用途 | 原文件名 |
|--------|------|---------|
| `hero-bg.png` | 页面顶部头图背景 | 头图背景 |
| `badge-free.png` | 右上角"免"字奖励标识贴纸 | 奖励标识 |
| `title-bg.png` | 活动权益区块标题底纹 | 标题背景 |
| `icon-benefit-1.png` | 权益图标（亏必补） | 奖励详情-免 |
| `icon-benefit-2.png` | 权益图标（免佣保底） | 奖励详情-免-1 |
| `icon-benefit-3.png` | 权益图标（100%给到司机） | 奖励详情-免-2 |
| `driver-thumb.png` | 进行中/获奖状态司机插画 | 小滴竖大拇指 |
| `driver-sad.png` | 已结束未获奖状态插画 | 分组 12 |
| `timeline-dot.png` | 活动进度时间轴节点图标 | 编组 24 |
...
### HTML 模式
- 所有资产路径相对于 page 文件，如 `../../assets/images/hero-bg.png`
- 字体通过 `@font-face` 引入 `../../assets/fonts/MFYuanHei-Boldtalic.ttf`
